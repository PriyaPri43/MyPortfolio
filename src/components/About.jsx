...
const About = () => {
    return (
        <div name='about' className='w-full py-20 bg-white text-gray-900 dark:bg-primary dark:text-gray-300'>
            <div className='flex flex-col justify-center items-center w-full h-full'>
                ...
                <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className='sm:text-right text-4xl font-bold text-gray-900 dark:text-gray-100' 
                    >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <p className="mb-4 text-lg leading-relaxed text-gray-600 dark:text-[#8892b0]">
                        ...
                        <p className="text-lg leading-relaxed text-gray-600 dark:text-[#8892b0]">
