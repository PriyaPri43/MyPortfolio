...
const Hero = () => {
    return (
        <div name='home' className='w-full min-h-screen bg-primary flex flex-col justify-center items-center text-center px-4 relative overflow-hidden'>

            {/* Dynamic Background Elements */}
            <div className="absolute top-[-20%] left-[-20%] w-[500px] h-[500px] bg-accent opacity-10 rounded-full blur-[100px] animate-blob"></div>
            ...
            >
                <motion.p
                    className='text-accent font-semibold tracking-[0.2em] text-lg mb-4 uppercase'
                ...
                <div className='text-3xl sm:text-5xl font-bold text-[#8892b0] mb-8 h-[60px] sm:h-[80px] flex items-center justify-center'>
                    <TypeAnimation
                        sequence={[
                ...
                <p className='text-[#8892b0] text-lg sm:text-xl py-4 max-w-[700px] leading-relaxed mx-auto'>
                ...
                <div className="flex flex-col sm:flex-row gap-6 mt-8">
                    ...
                    <a href="./Priyanka_MERN_Developer_2026.pdf" download>
                        <button className='text-white border border-gray-600 bg-white/5 backdrop-blur-sm px-8 py-4 flex items-center gap-3 rounded-full font-bold hover:bg-white/10 hover:border-white hover:scale-105 transition-all duration-300'>
                            Download Resume
